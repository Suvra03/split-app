...
import { ArrowLeft, Calendar, FileText, ChevronDown, ChevronUp, User, Users } from 'lucide-react';
...
function ReportCard({ report, index }) {
    ...
    // Calculate Balances for this Snapshot
    ...
    return (
        <GlassCard delay={index * 0.1} className="bg-zinc-900/40 border-zinc-800/40 overflow-hidden">
            {/* Header */}
            <div
            ...
            >
                ...
                <div className={`p-2 rounded-full transition-all ${expanded ? 'bg-zinc-800 text-white' : 'text-zinc-600 hover:text-zinc-400'}`}>
